        ...
        <div className='main-footer my-5'>
            ...
            <div className='d-flex my-3'>
                <div className='footer-div'>
                    ...
                    <p>Privacy & Terms<i className="bi bi-chevron-compact-down ml-1"></i> </p>
                    <p>Sales Solutions</p>
                    <p>Safety Center</p>
                ...
                <div className='footer-div-link'>
                    <div className='d-flex'>
                        <div><i className="bi bi-question-circle-fill p-2 icon-size-small"></i></div>
                        <div>
                    ...
                    <div className='d-flex'>
                        <div><i className="bi bi-gear-fill p-2 icon-size-small"></i></div>
                        <div>
                            <p><strong>Questions?</strong></p>
                            <p><small>Visit our Help Center.</small></p>
                        </div>
            ...
            <div><small>LinkedIn Corporation © 2022</small></div>
        </div>
    )
}
